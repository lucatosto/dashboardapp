...
function populateTable() {
    ...
    var tableContent = '';
        ...
        $.getJSON( '/customers/customerlist', function( data ) {

        customerListData = data;
        // Customername link click
        $('#customerList table tbody').on('click', 'td a.linkshowcustomer', showCustomerInfo);
        // For each item in our JSON, add a table row and cells to the content string
        $.each(data, function(){
            tableContent += '<tr>';
            tableContent += '<td>' + this.name + '</a></td>';
            tableContent += '<td><a href=" /dashboard ">Dashboard</a>'+this.id+'</td>';
            tableContent += '<td>' + this.id + '</td>';
            tableContent += '<td><a href="#" class="linkdeletecustomer" rel="' + this._id + '">delete</a></td>';
            tableContent += '</tr>';
        });
